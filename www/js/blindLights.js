...
var contrBlindLights = angular.module('starter', ['ionic', 'ngTouch'])


contrBlindLights.run(function($ionicPlatform) {
...
contrBlindLights.controller('CtrlBlindLights', function($scope, $window) {
  ...
  div.addEventListener("touchstart", function(e){
    ...
    div.addEventListener("touchend", function(e){
        ...
        var swiperightBol;
        swiperightBol = (elapsedTime >= allowedTime && dist >= thresholdRight && Math.abs(touchobj.pageY - startY) <= 100);  
